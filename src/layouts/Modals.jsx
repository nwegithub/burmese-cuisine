...
const Modals = ({ openIngredientModal, setOpenIngredientModal, openRecipeModal, setOpenRecipeModal }) => {
                ...
                >
                    ...
                    <Box sx={{
                        ...
                        <Typography className='relative m-h-[1000px] h-full w-full overflow-y-scroll top-8'>
                            ...
                            <div className="flex justify-center space-x-2  overflow-y-scroll"
                                style={{ height: '200px', flexDirection: 'row', marginTop: '20px' }}>
                                ...
                                <Button
                                    ...
                                    style={{ color: 'black' }}
                                >
                                    <MdKeyboardDoubleArrowLeft size = {12} style={{ marginRight: '5px' }} />
                                    Cancel
                                    </Button>
                                    ...
                                    <MdLocalGroceryStore size={12} style={{ marginRight: '8px' }} />
                                    Shop
                                </Button>
                            </div>
                ...
                >
                    ...
                    <Box sx={{
                        ...
                        <Typography className='relative m-h-[1000px] h-full w-full overflow-y-scroll top-10'>
                            <p>
                                LLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's . It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.

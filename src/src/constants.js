...
export const categories = [
  ...
  { name: "Kachin Traditional Food", icon: OndemandVideoIcon },
  { name: "Kayar Traditional Food", icon: OndemandVideoIcon },
  { name: "Kayin Traditional Food", icon: OndemandVideoIcon },

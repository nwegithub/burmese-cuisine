          ...
          {adEspressoQuestions.map((item, index) => (
            <div key={`adEspresso-${index}`}>
              <p
                ...
                onClick={() => toggleAnswer(`adEspresso-${index}`)}
              >
                {isMya
                  ? `${convertToMyanmarNumber(index + 1)}။`
                  : `${index + 1}.`}
                {isMya ? item.question.mya : item.question.en}
              </p>
          ...
          {onlineAdvertisingQuestions.map((item, index) => (
            <div key={`onlineAd-${index}`}>
              <p
                className='body'
                style={styles.question}
                onClick={() => toggleAnswer(`onlineAd-${index}`)}
              >
                {isMya
                  ? `${convertToMyanmarNumber(index + 7)}။`
                  : `${index + 7}.`}
                {isMya ? item.question.mya : item.question.en}
              </p>
